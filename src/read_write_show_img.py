...
# read image
img = cv2.imread("src/assets/img/lena.jpg", 1) # 0 = grayscale = cv2.IMREAD_GRAYSCALE -- 1 = color = cv2.IMREAD_COLOR -- -1 = unchanged = cv2.IMREAD_UNCHANGED -> include alpha channel
...
if key == 27:
    ...
    cv2.imwrite("src/assets/saved_frames/lena_copy.png", img)
    cv2.destroyAllWindows()
'''
